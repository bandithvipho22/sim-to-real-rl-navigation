...
def main():
    ...
    sdf_file_path = os.path.join(
        get_package_share_directory("rl_gazebo"), "models",
    ...
    desired_angle = float(math.radians(0)) #-90
    ...
    request.initial_pose.position.x = float(-4.93)
    request.initial_pose.position.y = float(1.34)
